    ...
    public void start() {
       ...
       myCommand.scheduleCommand(
               new WaitCommand(2)
                       ...
                       .then(new EncoderStraightDriveCommand(drive,"forward",7.5,false))
                       ...
                       //.then(new WaitCommand(1))
                        .then(new RunCommand(() -> {
                            ...
                            if (location == 3) {
                                myCommand.scheduleCommand(new EncoderTurnDriveCommand(drive,"cw",85));
                            }

                        }))
                       .then(new DriveCommand(drive,0,0.2,0,1,true))
                        .then(new RunCommand(() -> {
